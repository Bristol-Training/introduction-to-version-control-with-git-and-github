---
title: "Backing up to the cloud (GitHub)"
---
...
We have one new command, `git push`, that pushes (backs up) versions that are committed locally to a remote git hosting service. This completes our [Cheat Sheet](./910-cheat-sheet.qmd).
...
::: {#exercise-1 .callout-important title="WARNING" icon=ture}
